...
namespace Scripts.UI
{
    ...
    {
        public void SetRed(float value) => OnValueChanged(value, 0);

        public void SetGreen(float value) => OnValueChanged(value, 1);

        public void SetBlue(float value) => OnValueChanged(value, 2);
